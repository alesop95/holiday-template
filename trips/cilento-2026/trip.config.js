...
// c: colore esadecimale del marker, em: emoji sovrapposta, d: id del giorno.

export const MAP_LOCATIONS = [
  { lat:40.0064, lng:15.3743, nm:"Marina di Camerota", sub:"🏨 Base 1 · Giorni 1–4",      c:"#2B5C8A", em:"🏨" },
  { lat:40.0547, lng:15.4874, nm:"Scario",             sub:"🛶 Giorno 1 pomeriggio",       c:"#2B5C8A", em:"🛶" },
  { lat:40.1205, lng:15.5134, nm:"Policastro Bussentino", sub:"🏰 Giorno 1 sera",          c:"#2B5C8A", em:"🏰" },
  { lat:40.0222, lng:15.3340, nm:"Baia degli Infreschi",  sub:"🌊 Giorno 2 trekking",      c:"#1A7A6E", em:"🌊" },
  { lat:40.0308, lng:15.2875, nm:"Palinuro",           sub:"🚤 Giorno 3 barca",            c:"#4A90B8", em:"🚤" },
  { lat:40.3786, lng:15.3684, nm:"Sacco — Gole del Sammaro", sub:"💧 Giorno 4",           c:"#6B8E3E", em:"💧" },
  { lat:40.3753, lng:15.2806, nm:"Roscigno Vecchia",   sub:"👻 Giorno 4 pomeriggio",      c:"#6B8E3E", em:"👻" },
  { lat:40.2850, lng:14.9608, nm:"Castellabate",       sub:"🏰 Giorno 5 mattino",         c:"#C4832A", em:"🏰" },
  { lat:40.4200, lng:15.0037, nm:"Paestum",            sub:"🏺 Giorno 5 pomeriggio",      c:"#C4832A", em:"🏺" },
  { lat:40.5797, lng:15.4706, nm:"Grotte di Pertosa-Auletta", sub:"🦇 Giorno 6 gita",     c:"#7B4F9E", em:"🦇" },
  { lat:41.0749, lng:14.3328, nm:"Caserta — Reggia",   sub:"🏨 Base 2 + 👑 Giorno 7",    c:"#B03A2E", em:"👑" },
];
...
export const TRIP_DATA = {
  ...
  days: [
    {
      id:1, color:"#2B5C8A", icon:"🚗", label:"Giorno 1",
      ...
      sections:[
        ...
        { i:"🛶", t:"Pomeriggio — Scario & Policastro",
    ...
    },
    {
      ...
      sections:[
        ...
        { i:"🗺️", t:"Il Percorso — Sentiero Mediterraneo",
        ...
        { i:"⛵", t:"Alternativa — Trekking + Barca",
      ...
      tips:["⚠️ Scarpe da trekking obbligatorie — no sandali, no sneakers","Porta costume: si fa il bagno nelle calette","Crema solare 50+ e cappello — ombra scarsa in estate"],
      cf:"5–15", ca:"0"
    },
    {
      id:3, color:"#4A90B8", icon:"🚤", label:"Giorno 3",
      ...
      sections:[
        ...
        { i:"🌊", t:"Mattino — Escursione in Barca",
    ...
    {
      id:4, color:"#6B8E3E", icon:"🏔️", label:"Giorno 4",
      ...
      sections:[
        ...
        { i:"👻", t:"Pomeriggio — Roscigno Vecchia",
    ...
    {
      id:6, color:"#7B4F9E", icon:"🦇", label:"Giorno 6",
      ...
      sections:[
        ...
        { i:"🦇", t:"Le Grotte di Pertosa-Auletta",
  ...
  restaurants: [
    { area:"🌊 Scario & Policastro", days:"Giorno 1 sera", items:[
      { em:"🌿", nm:"L'Uorto",     tags:["Cilentana","$$"],  note:"Il ristorante storico di Policastro. Cucina tradizionale con orto proprio e giardino esterno. Alici di Menaica, caciocavallo podolico, strozzapreti al polpo.", sp:"★ Prenotare — molto richiesto in stagione" },
      { em:"🐟", nm:"Da Fernando", tags:["Pesce","$-$$"],    note:"A Scario, sul porto. Pesce fresco del Golfo di Policastro, frittura mista, spaghetti alle vongole." },
    ]},
    { area:"🏖️ Marina di Camerota — Cene", days:"Giorni 2, 3, 4", items:[
      { em:"🦞", nm:"Il Torrione",           tags:["Pesce","$$$"],    note:"Terrazza panoramica con vista sul mare. Eccellente per crudi di mare e pasta ai ricci.", sp:"♥ Perfetto per una serata romantica" },
      { em:"🍝", nm:"Osteria del Porto",      tags:["Pesce","$$"],     note:"Vicino al porto. Cucina di mare genuina: alici marinate, vongole, grigliata mista." },
      { em:"🧀", nm:"La Cantina di Lu'Orto", tags:["Cilentana","$-$$"], note:"Cucina dell'entroterra: fagioli di Controne, formaggi locali. Buona alternativa al pesce." },
    ]},
    { area:"🌿 Entroterra Cilentano", days:"Giorno 4 pranzo", items:[
      { em:"🌾", nm:"Azienda Agricola Oasi Infreschi", tags:["Bio","$"], note:"SUL SENTIERO degli Infreschi. Prodotti biologici propri: formaggi, conserve, piatti semplici e straordinari.", sp:"★ Non perderla — è sul percorso del trekking (Giorno 2)" },
      { em:"🧀", nm:"Trattoria La Piazzetta",          tags:["Contadina","$"], note:"A Roscigno, cucina rurale cilentana: pasta e fagioli, pane fatto in casa. Prezzi bassissimi." },
    ]},
    { area:"🏰 Castellabate & Paestum", days:"Giorno 5 pranzo", items:[
      { em:"🌊", nm:"Acquamarina",        tags:["Pesce","$$"],     note:"A Santa Maria di Castellabate, in riva al mare. Pesce del giorno, frittura di paranza." },
      { em:"🏺", nm:"Ristorante Nettuno", tags:["Campana","$$-$$$"], note:"Storico ristorante di Paestum, di fronte ai Templi. Pasta e fagioli con cozze, bufala fresca.", sp:"★ Vista sui Templi — prenotare in estate" },
      { em:"🐃", nm:"Caseificio del Borgo", tags:["Bufala","$"],   note:"Mozzarella di bufala DOP fresca dal produttore, prodotta ogni mattina alle 5.", sp:"♥ Esperienza cilentana autentica" },
    ]},
    { area:"👑 Caserta", days:"Giorni 5, 6, 7", items:[
      { em:"🍕", nm:"Pepe in Grani",         tags:["Pizza","$-$$"], note:"A Caiazzo, 30 min da Caserta. Tra le migliori pizzerie d'Italia. Prenotazione obbligatoria.", sp:"★ Vale il viaggio — prenotare sempre" },
      { em:"🍕", nm:"Pizzeria Sorbillo Caserta", tags:["Pizza","$-$$"], note:"Pizza napoletana classica in centro Caserta. Qualità garantita, senza prenotazione." },
      { em:"🍝", nm:"Trattoria La Maschera", tags:["Campana","$$"],  note:"Cucina campana: pasta e patate, genovese di cipolla, ziti al ragù." },
    ]},
  ],
  ...
  checklist: [
    ...
    { cat:"👗 Abbigliamento", items:[
      ...
      { t:"Scarpe da trekking",           n:"⚠️ Obbligatorie Giorno 2" },
